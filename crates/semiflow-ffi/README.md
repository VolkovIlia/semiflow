...
Built on the `semiflow` core crate (current public version: 0.13.1-beta). The
...
Example output: `sup_error=1.460e-6  version=0.13.1-beta`
...
| `smf_version` | `() → const char *` | Crate version string, e.g. `"0.13.1-beta"`. Do not free. |
