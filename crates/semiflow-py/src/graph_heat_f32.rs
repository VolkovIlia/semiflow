...
use semiflow::{
    ...
    LaplacianAtTime, MagnusGraphHeatChernoff, ScratchPool, SemiflowError, VarCoefGraphHeatChernoff,
};
...
pub(crate) fn build_lap_f32_from_lap_f64(lap64: &Laplacian<f64>) -> Arc<semiflow::Laplacian<f32>> {
    let n = lap64.n_nodes();
